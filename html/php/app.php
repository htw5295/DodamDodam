...
putenv('GOOGLE_APPLICATION_CREDENTIALS=servic-account.json');
$client = new Google_Client();
$client->useApplicationDefaultCredentials();
//$client->setApplicationName("DodamDodam");
//$client->setDeveloperKey("485734319788-2ug0k9kia60cp46eculj1phmclal5fvt.apps.googleusercontent.com");
